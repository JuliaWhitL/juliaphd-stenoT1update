...
dag <- dagitty('dag {
  sex -> age
  sex -> diabetes_duration
  age -> diabetes_duration
  sex -> value_SBP
  age -> value_SBP
  diabetes_duration -> value_SBP
  sex -> value_LDL
  age -> value_LDL
  diabetes_duration -> value_LDL
  value_SBP -> value_LDL
  sex -> value_HBA1C
  age -> value_HBA1C
  diabetes_duration -> value_HBA1C
  value_SBP -> value_HBA1C
  value_LDL -> value_HBA1C
  sex -> log2_eGFR_young
  age -> log2_eGFR_young
  diabetes_duration -> log2_eGFR_young
  value_SBP -> log2_eGFR_young
  value_LDL -> log2_eGFR_young
  value_HBA1C -> log2_eGFR_young
  value_Albuminuria -> log2_eGFR_young
  sex -> log2_eGFR_old
  age -> log2_eGFR_old
  diabetes_duration -> log2_eGFR_old
  value_SBP -> log2_eGFR_old
  value_LDL -> log2_eGFR_old
  value_HBA1C -> log2_eGFR_old
  value_Albuminuria -> log2_eGFR_old
  log2_eGFR_young -> log2_eGFR_old
  sex -> value_Smoking
  age -> value_Smoking
  diabetes_duration -> value_Smoking
  value_SBP -> value_Smoking
  value_LDL -> value_Smoking
  value_HBA1C -> value_Smoking
  value_Albuminuria -> value_Smoking
  log2_eGFR_young -> value_Smoking
  log2_eGFR_old -> value_Smoking
  sex -> value_Motion
  age -> value_Motion
  diabetes_duration -> value_Motion
  value_SBP -> value_Motion
  value_LDL -> value_Motion
  value_HBA1C -> value_Motion
  value_Albuminuria -> value_Motion
  log2_eGFR_young -> value_Motion
  log2_eGFR_old -> value_Motion
  value_Smoking -> value_Motion
  sex -> time_CVD
  age -> time_CVD
  diabetes_duration -> time_CVD
  value_SBP -> time_CVD
  value_LDL -> time_CVD
  value_HBA1C -> time_CVD
  value_Albuminuria -> time_CVD
  log2_eGFR_young -> time_CVD
  log2_eGFR_old -> time_CVD
  value_Smoking -> time_CVD
  value_Motion -> time_CVD
  sex -> time_Death
  age -> time_Death
  diabetes_duration -> time_Death
  value_SBP -> time_Death
  value_LDL -> time_Death
  value_HBA1C -> time_Death
  value_Albuminuria -> time_Death
  log2_eGFR_young -> time_Death
  log2_eGFR_old -> time_Death
  value_Smoking -> time_Death
  value_Motion -> time_Death
  sex -> time_Censored
  age -> time_Censored
  diabetes_duration -> time_Censored
  value_SBP -> time_Censored
  value_LDL -> time_Censored
  value_HBA1C -> time_Censored
  value_Albuminuria -> time_Censored
  log2_eGFR_young -> time_Censored
  log2_eGFR_old -> time_Censored
  value_Smoking -> time_Censored
  value_Motion -> time_Censored
}')
